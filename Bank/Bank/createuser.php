...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/createuser1.css">
    <link rel="stylesheet" type="text/css" href="css/style1.css">
</head>

<body style="background-color:#BBEDCD">
<?php
    include 'config.php';
  ...
  <div class="container1">
    <div class="screen">
      ...
      <div class="screen-body">
        ...
        <div class="screen-body-item left" style="margin-top:-3em">
          <img class="img-fluid" src="img/2.svg" style="border: none; border-radius: 10%;">
        </div>
